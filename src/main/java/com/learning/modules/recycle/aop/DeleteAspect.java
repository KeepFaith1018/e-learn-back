package com.learning.modules.recycle.aop;

import cn.hutool.core.convert.Convert;
import cn.hutool.core.util.ObjUtil;
import cn.hutool.json.JSONObject;
import com.learning.core.annotation.IgnoreRecycleData;
...
import com.learning.modules.recycle.entity.RecycleDataEntity;
import com.learning.modules.recycle.service.RecycleDataService;
...
public class DeleteAspect {
    ...
    @Around(value = "execution(* com.learning.core.base.BaseController.delete*(..)) && args(request, params, requestParams)", argNames = "joinPoint,request,params,requestParams")
